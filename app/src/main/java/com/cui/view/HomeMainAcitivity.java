...
import com.cui.R;
import com.cui.view.other.SystemScreenInfo;
import com.cui.view.ui.AnimationTabHost;
...
public class HomeMainAcitivity extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SystemScreenInfo.getSystemInfo(HomeMainAcitivity.this);
	...
	private int getImageId(int index, boolean isSelect) {
		...
		switch (index) {
		case 0:
			result = isSelect ? R.drawable.tab_dial_selected
					: R.drawable.tab_dial_normal;
			break;
		case 1:
			result = isSelect ? R.drawable.tab_contact_selected
					: R.drawable.tab_contact_normal;
			break;
		case 2:
			result = isSelect ? R.drawable.tab_sms_selected
					: R.drawable.tab_sms_normal;
			break;
		case 3:
			result = isSelect ? R.drawable.tab_settings_selected
	...
	private void init() {
		setIndicator("拨号", 0, new Intent(this, HomeDialActivity.class),
				R.drawable.tab_dial_selected);
		setIndicator("联系人", 1, new Intent(this, HomeContactActivity.class),
				R.drawable.tab_contact_normal);
		setIndicator("信息", 2, new Intent(this, HomeSMSActivity.class),
				R.drawable.tab_sms_normal);
		setIndicator("设置", 3, new Intent(this, HomeSettintActivity.class),
				R.drawable.tab_settings_normal);
